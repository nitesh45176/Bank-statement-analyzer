      ...
      <header className="bg-blue-900 h-15 flex items-center gap-3 px-8 h-[60px]">
        <div className="w-7 h-7 bg-blue-600 rounded-md flex items-center justify-center flex-shrink-0">
          <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8" className="w-4 h-4">
            ...
            <path d="M3 12h18" />
            <rect x="7" y="4" width="10" height="5" rx="1.5" fill="#93C5FD" stroke="none" />
          </svg>
        </div>
        <span className="text-white font-semibold text-sm tracking-wide">Statement Analyzer</span>
      </header>
        ...
        {data && (
          <>
            ...
            <div className="flex items-center justify-between mt-7 mb-3">
              <span className="text-[11px] font-semibold tracking-widest uppercase text-slate-400">Overview</span>
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              <TopTransactions title="Top Credits" transactions={data.top_credits} type="credit" />
              <TopTransactions title="Top Debits" transactions={data.top_debits} type="debit" />
            </div>
          </>
        )}
      </div>
